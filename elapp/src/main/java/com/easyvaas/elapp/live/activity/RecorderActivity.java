...
//            hideUserPopupView();
//            switch (v.getId()) {
//                case R.id.live_options_left_arrow_iv:
//                    findViewById(R.id.live_options_right_ll).setVisibility(View.VISIBLE);
//                    findViewById(R.id.live_options_left_ll).setVisibility(View.GONE);
//                    break;
//                case R.id.live_options_right_arrow_iv:
//                    findViewById(R.id.live_options_right_ll).setVisibility(View.GONE);
//                    findViewById(R.id.live_options_left_ll).setVisibility(View.VISIBLE);
//                    break;
...
//                    break;
//                case R.id.live_send_red_pack_iv:
...
//                            }
//                            CheckBox checkBox = (CheckBox) findViewById(R.id.live_flash_cb);
...
//        super.initView();
//        findViewById(R.id.live_gift_iv).setVisibility(View.GONE);
...
//        viewStub = (ViewStub) findViewById(R.id.v_call_users_stub);
//        mVCallUserView = viewStub.inflate();
//        VideoCallHelper.getInstance().setRequestUserView(mVCallUserView);
//
...
//
//        mOptionsView = recorderView.findViewById(R.id.live_options_ll);
...
//            }
//        });
//        mOptionsView.findViewById(R.id.live_options_left_arrow_iv).setOnClickListener(mOnClickListener);
//        mOptionsView.findViewById(R.id.live_comment_iv).setOnClickListener(mOnClickListener);
//        mOptionsView.findViewById(R.id.live_video_call_iv).setOnClickListener(mOnClickListener);
//        mOptionsView.findViewById(R.id.live_share_iv).setOnClickListener(mOnClickListener);
//        mOptionsView.findViewById(R.id.live_mute_cb).setOnClickListener(mOnClickListener);
//        mOptionsView.findViewById(R.id.live_options_right_arrow_iv).setOnClickListener(mOnClickListener);
//        CheckBox flashSwitchCb = (CheckBox) recorderView.findViewById(R.id.live_flash_cb);
//        CheckBox cameraSwitchCb = (CheckBox) recorderView.findViewById(R.id.live_switch_camera_cb);
//        CheckBox beautySwitchCb = (CheckBox) recorderView.findViewById(R.id.live_beauty_cb);
//        if (mLiveConfig != null) {
...
//        ((CheckBox) mOptionsView.findViewById(R.id.live_mute_cb))
...
//            recorderView.findViewById(R.id.live_send_red_pack_iv).setOnClickListener(mOnClickListener);
//        } else {
//            recorderView.findViewById(R.id.live_send_red_pack_iv).setVisibility(View.INVISIBLE);
//        }
//
//        showLivingInfo();
//    }
...
//        mTopInfoAreaView.findViewById(R.id.live_close_iv).setOnClickListener(mOnClickListener);
//        showRecordOptionView();
//
//        if (EVApplication.getUser() == null) {
//            return;
//        }
//        Utils.showImage(EVApplication.getUser().getLogourl(), R.drawable.somebody, mUserLogoIv);
