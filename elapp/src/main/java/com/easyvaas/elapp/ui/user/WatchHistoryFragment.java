...
public class WatchHistoryFragment extends BaseListRcvFragment {
    ...
    public void iniView(View view) {
        ...
        mRecyclerView.setAdapter(mMyAdapter = new WatchHistoryAdapter(mRecordLists, getActivity(),false));
    }
    ...
    public void onMessageEvent(HistoryDeleteEvent messageEvent) {
