...
public class ExponentListNewModel {
    ...
    public static class DataEntity {
        private List<CnEntity> cn;
        private List<HkEntity> hk;

        public List<CnEntity> getCn() {
            return cn;
        }

        public void setCn(List<CnEntity> cn) {
            this.cn = cn;
        }
        ...
        public void setHk(List<HkEntity> hk) {
            this.hk = hk;
        }
        ...
        public static class HkEntity {
            /**
             * datetime : 2017-02-28 14:26:22
             * amount : 423.163
             * change : -0.08
             * close : 3868.36
             * symbol : HKHSCCI
