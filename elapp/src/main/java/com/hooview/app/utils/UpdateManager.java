...
public class UpdateManager {
    ...
    private static final String SAVE_FILE_NAME = SAVE_PATH + "/" + "yizhibo.apk";
    ...
    private void showUpdateDialog(final UpdateDialogListener dialogListener) {
        View dialogView = LayoutInflater.from(mContext).inflate(com.hooview.app.R.layout.app_update_dialog, null);
        TextView appUpdateVersionNameTv = (TextView) dialogView.findViewById(com.hooview.app.R.id.app_update_version_name_tv);
        TextView appSizeTv = (TextView) dialogView.findViewById(com.hooview.app.R.id.app_size_tv);
        TextView appUpdateContent = (TextView) dialogView.findViewById(com.hooview.app.R.id.app_update_content_tv);
        if (mUpdateInfo != null) {
            appUpdateVersionNameTv.setText(
                    mContext.getString(com.hooview.app.R.string.app_new_version_name, mUpdateInfo.getUpdate_version()));
            appSizeTv.setText(mContext.getString(com.hooview.app.R.string.app_new_version_size,
                    (float) (mUpdateInfo.getTarget_size()) / 1024 / 1024));
            appUpdateContent.setText(mUpdateInfo.getUpdate_log());
        }
        Button appUpdateIdOk = (Button) dialogView.findViewById(com.hooview.app.R.id.app_update_id_ok);
        Button appUpdateIdCancel = (Button) dialogView.findViewById(com.hooview.app.R.id.app_update_id_cancel);
    ...
    public void showDownloadDialog() {
        ...
        builder.setTitle(com.hooview.app.R.string.soft_update_tip);

        final LayoutInflater inflater = LayoutInflater.from(mContext);
        View v = inflater.inflate(com.hooview.app.R.layout.view_dowload_process, null);
        mProgressBar = (ProgressBar) v.findViewById(com.hooview.app.R.id.download_process);

        builder.setView(v);
        if (!isForceUpdate()) {
            builder.setNegativeButton(com.hooview.app.R.string.cancel, new DialogInterface.OnClickListener() {
                @Override
        ...
        if (mDownloadStatus == DownloadStatus.Complete) {
            ...
            builder.setPositiveButton(com.hooview.app.R.string.install_software, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    installApk();
                }
