...
public class Constants {
    //======================== HX chat ===========================//
//    public static final String HX_CHAT_APP_KEY = "";  //TODO Need to change yours
//
//    //======================== SNS PLATFORM AUTH/SHARE ===========//
//    public static final String WEIXIN_APP_ID = "";    //TODO Need to change yours
//    public static final String WEIXIN_APP_SECRET = "";//TODO Need to change yours
//    public static final String QQ_APP_ID = "";        //TODO Need to change yours
//    public static final String WEIBO_APP_ID = "";     //TODO Need to change yours
//
//    //======================== Baichuan Feedback =================//
//    public static final String APP_FEEDBACK_KEY = ""; //TODO Need to change yours
//
//    //======================== Umeng statistics ==================//
//    public static final String UMENG_APP_KEY = "";    //TODO Need to change yours
//
//    //======================== EasyVaas ==========================//
//    public static final String EV_APP_ID = "";        //TODO Need to change yours
//    public static final String EV_ACCESS_ID = "";     //TODO Need to change yours
//    public static final String EV_SECRET_ID = "";     //TODO Need to change yours
    //======================== HX chat ===========================//
    ...
    //======================== EasyVaas ==========================//
    public static final String EV_APP_ID = "r7Mun6JpcwHiSdIh";        //TODO Need to change yours
    public static final String EV_ACCESS_ID = "hdxLQK1jMMRRQlST";     //TODO Need to change yours
    public static final String EV_SECRET_ID = "S6HQDY9M4LKnaosPrR7CZWQnsEvFgHWy";     //TODO Need to change yours
    ...
    public static final String ACTION_GO_HOME_ACTIVITY = "action_tab_concern";
    public static final String ACTION_GO_HOME_TIMELINE = "action_tab_discover";
    ...
    public static final String ACTION_HIDE_HOME_TITLE_BAR = "action_hide_home_title_bar";
    public static final String ACTION_SHOW_HOME_TITLE_BAR = "action_show_home_title_bar";
    public static final String ACTION_CHANGE_HOME_TOPIC = "action_change_home_topic";

    public static final String ACTION_CLOSE_CURRENT_VIDEO_PLAYER = "action_close_current_video_player";

    public static final String EXTRA_KEY_LIVE_CONFIG = "extra_key_play_config";
    public static final String EXTRA_KEY_VIDEO_ID = "extra_video_id";
    public static final String EXTRA_KEY_VIDEO_IS_LIVE = "extra_key_video_is_live";
    ...
    public static final String EXTRA_KEY_USER_IM_ID = "extra_key_user_im_id";
