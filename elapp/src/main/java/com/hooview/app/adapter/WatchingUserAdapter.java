...
public class WatchingUserAdapter extends RecyclerView.Adapter<WatchingUserAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        public ViewHolder(View view) {
            super(view);
            mLogoIv = (MyUserPhoto) view.findViewById(com.hooview.app.R.id.watching_user_logo_iv);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(mInflater.inflate(com.hooview.app.R.layout.item_watching_user, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        Utils.showImage(mListData.get(i).getLogourl(), com.hooview.app.R.drawable.guestavatar, viewHolder.mLogoIv);
    }
