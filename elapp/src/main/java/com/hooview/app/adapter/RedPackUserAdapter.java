...
public class RedPackUserAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(context).inflate(com.hooview.app.R.layout.item_red_pack_user, parent, false);
            holder.userLogo = (ImageView) view.findViewById(com.hooview.app.R.id.red_pack_user_photo);
            holder.nameTv = (TextView) view.findViewById(com.hooview.app.R.id.red_pack_nickname_tv);
            holder.amountTv = (TextView) view.findViewById(com.hooview.app.R.id.red_pack_amount_tv);
            holder.bestTagTv = (TextView) view.findViewById(com.hooview.app.R.id.red_pack_best_tv);
            view.setTag(holder);
        } else {
        ...
        holder.amountTv.setText(context.getString(com.hooview.app.R.string.e_coin_count_rear, bean.getEcoin()));
