...
public class CountryCodeAdapter extends BaseAdapter
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(com.hooview.app.R.layout.item_city_letter_sort, viewGroup, false);
            viewHolder.tvTitle = (TextView) view.findViewById(com.hooview.app.R.id.title);
            viewHolder.tvCode = (TextView) view.findViewById(com.hooview.app.R.id.name_code_txv);
    ...
    public View getHeaderView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(com.hooview.app.R.layout.item_sticky_header, viewGroup, false);
            hViewHolder.tvLetter = (TextView) view.findViewById(com.hooview.app.R.id.sticky_header_letter_tv);
