...
public class UserInfoSnsActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCommonTitleTv = (TextView) findViewById(com.hooview.app.R.id.common_custom_title_tv);
        findViewById(com.hooview.app.R.id.close_iv).setVisibility(View.INVISIBLE);
        findViewById(com.hooview.app.R.id.user_info_item_6).setOnClickListener(this);
        TextView addOptionTv = (TextView) findViewById(com.hooview.app.R.id.add_option_iv);
        addOptionTv.setText(com.hooview.app.R.string.complete);
        mCommonTitleTv.setText(com.hooview.app.R.string.user_info_set);
        findViewById(com.hooview.app.R.id.camera_iv).setVisibility(View.GONE);
        mPortraitIv = (ImageView) findViewById(com.hooview.app.R.id.user_info_portrait_iv);
        mYzbNameTv = (TextView) findViewById(com.hooview.app.R.id.user_info_nickname_et);
        mYzbNameTv.setOnClickListener(this);
        mYzbIdEt = (EditText) findViewById(com.hooview.app.R.id.yb_id_et);
        ...
        mLocationTv = (TextView) findViewById(com.hooview.app.R.id.ui_location_et);
        mLocationTv.setText(com.hooview.app.R.string.default_user_location);
        mSignatureTv = (TextView) findViewById(com.hooview.app.R.id.signature_et);
        ...
        if (mIsSetRegisterInfo) {
            addOptionTv.setText(com.hooview.app.R.string.next_step);
        } else {
            addOptionTv.setText(com.hooview.app.R.string.complete);
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case com.hooview.app.R.id.user_info_portrait_iv:
                mSetThumbPanel.show();
                break;
            case com.hooview.app.R.id.add_option_iv:
    ...
    private void snsUserRegistration(final Bundle userInfo) {
        ...
        if (nickname.equals(getResources().getString(com.hooview.app.R.string.nickname))) {
            mYzbNameTv.setText("");
            SingleToast.show(getApplicationContext(), com.hooview.app.R.string.msg_nickname_empty);
            return;
        }
        ...
        showLoadingDialog(com.hooview.app.R.string.submit_data, false, true);
                        ...
                        refreshToken, logoUrl, new MyRequestCallBack<User>() {
                            ...
                            public void onSuccess(User user) {
                                if (user != null && !isFinishing()) {
                                    ...
                                    SingleToast
                                            .show(getApplicationContext(), com.hooview.app.R.string.msg_registered_success);
                            ...
                            public void onError(String errorInfo) {
                                ...
                                if (ApiConstant.E_USER_EXISTS.equals(errorInfo)) {
                                    SingleToast.show(getApplicationContext(), com.hooview.app.R.string.msg_phone_registered);
                                }
                                dismissLoadingDialog();
                            }
