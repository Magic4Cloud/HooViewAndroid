...
public class TabMessageFragment extends BaseRvcFragment {
    ...
    private static class MyHandler extends android.os.Handler {
        private SoftReference<TabMessageFragment> softReference;

        public MyHandler(TabMessageFragment fragment) {
        ...
        public void handleMessage(Message msg) {
            ...
            TabMessageFragment fragment = softReference.get();
            if (fragment == null) {
                return;
            }
            switch (msg.what) {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(com.hooview.app.R.layout.fragment_message, container, false);
