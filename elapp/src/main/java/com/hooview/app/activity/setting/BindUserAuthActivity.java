...
import com.hooview.app.activity.login.BindOrChangePhoneActivity;
    ...
    private void setBindState(String type, boolean isBind, String token) {
        ...
        if (User.AUTH_TYPE_QQ.equals(type)) {
            ...
            if (isBind && (mIsPhoneBind || (mIsWeixinBind || mIsWeiboBind))) {
                mQQText.setBackgroundResource(R.drawable.common_stroke_round_three_btn_blue_selector);
                mQQText.setTextColor(getResources().getColor(R.color.btn_color_main));
