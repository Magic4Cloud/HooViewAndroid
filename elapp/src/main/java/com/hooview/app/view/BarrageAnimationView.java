...
public class BarrageAnimationView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        View barrageAnimationView = LayoutInflater.from(context)
                .inflate(com.hooview.app.R.layout.view_barrage_animation_view, null);
        mBarrageRl = (FrameLayout) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_rl);
        mBarrageNicknameTv = (TextView) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_username_tv);
        mBarrageContentTv = (TextView) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_content_tv);
        mBarrageUserIv = (MyUserPhoto) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_user_iv);

        mBarrageTwoRl = (FrameLayout) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_rl2);
        mBarrageNicknameTwoTv = (TextView) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_username_tv2);
        mBarrageContentTwoTv = (TextView) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_content_tv2);
        mBarrageUserTwoIv = (MyUserPhoto) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_user_iv2);

        mBarrageThreeRl = (FrameLayout) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_rl3);
        mBarrageNicknameThreeTv = (TextView) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_username_tv3);
        mBarrageContentThreeTv = (TextView) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_content_tv3);
        mBarrageUserThreeIv = (MyUserPhoto) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_user_iv3);

        mBarrageFourRl = (FrameLayout) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_rl4);
        mBarrageNicknameFourTv = (TextView) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_username_tv4);
        mBarrageContentFourTv = (TextView) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_content_tv4);
        mBarrageUserFourIv = (MyUserPhoto) barrageAnimationView.findViewById(com.hooview.app.R.id.barrage_user_iv4);
