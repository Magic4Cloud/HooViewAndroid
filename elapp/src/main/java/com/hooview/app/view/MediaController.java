...
public class MediaController extends FrameLayout implements IMediaController{
    ...
    protected View makeControllerView() {
        return ((LayoutInflater) mContext
                ...
                com.hooview.app.R.layout.media_controller, this);
    }

    private void initControllerView(View v) {
        mPauseButton = (ImageButton) v
                .findViewById(com.hooview.app.R.id.mediacontroller_play_pause);
        if (mPauseButton != null) {
            mPauseButton.requestFocus();
            mPauseButton.setOnClickListener(mPauseListener);
        }

        mProgress = (SeekBar) v.findViewById(com.hooview.app.R.id.mediacontroller_seekbar);
        if (mProgress != null) {
        ...
        mEndTime = (TextView) v.findViewById(com.hooview.app.R.id.mediacontroller_time_total);
        mCurrentTime = (TextView) v
                .findViewById(com.hooview.app.R.id.mediacontroller_time_current);
        mFileName = (TextView) v.findViewById(com.hooview.app.R.id.mediacontroller_file_name);
        if (mFileName != null)
...
//    }
    ...
    private void updatePausePlay() {
        ...
        if (mPlayer.isPlaying())
            mPauseButton
                    .setImageResource(com.hooview.app.R.drawable.video_pause_button);
        else
            mPauseButton
                    .setImageResource(com.hooview.app.R.drawable.video_play_button);
    }
