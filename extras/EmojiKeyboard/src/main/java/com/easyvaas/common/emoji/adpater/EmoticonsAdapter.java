package com.easyvaas.common.emoji.adpater;
...
import com.easyvaas.common.emoji.utils.imageloader.ImageBase;
import com.easyvaas.common.emoji.utils.imageloader.ImageLoader;
...
public class EmoticonsAdapter extends BaseAdapter {
    ...
    private String TAG = "EmoticonsAdapter";
        ...
        if (emoticonBean != null) {
            ...
            if (mOnItemListener != null) {
                if (ImageBase.Scheme.ofUri(emoticonBean.getIconUri()) == ImageBase.Scheme.UNKNOWN) {
                    String[] at = emoticonBean.getIconUri().split("[.]");
                    if (at.length > 1) {
                        int resID = mContext.getResources().getIdentifier(at[0], "drawable", mContext.getPackageName());
