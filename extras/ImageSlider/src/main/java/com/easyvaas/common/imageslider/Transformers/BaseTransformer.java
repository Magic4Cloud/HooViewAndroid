package com.easyvaas.common.imageslider.Transformers;
 ...
 *
 * BaseTransformer implement {@link com.easyvaas.common.imageslider.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.easyvaas.common.imageslider.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.easyvaas.common.imageslider.Animations.BaseAnimationInterface}
 * work.
 *
