...
import com.easyvaas.common.advancedRecyclerView.adapter.AdapterPath;
import com.easyvaas.common.advancedRecyclerView.adapter.ItemIdComposer;
import com.easyvaas.common.advancedRecyclerView.draggable.BaseEdgeEffectDecorator;
import com.easyvaas.common.advancedRecyclerView.draggable.BasicSwapTargetTranslationInterpolator;
import com.easyvaas.common.advancedRecyclerView.draggable.DraggableItemConstants;
import com.easyvaas.common.advancedRecyclerView.draggable.DraggableItemViewHolder;
import com.easyvaas.common.advancedRecyclerView.draggable.DraggingItemDecorator;
import com.easyvaas.common.advancedRecyclerView.draggable.DraggingItemEffectsInfo;
import com.easyvaas.common.advancedRecyclerView.draggable.DraggingItemInfo;
import com.easyvaas.common.advancedRecyclerView.draggable.ItemDraggableRange;
import com.easyvaas.common.advancedRecyclerView.draggable.LeftRightEdgeEffectDecorator;
import com.easyvaas.common.advancedRecyclerView.draggable.SwapTargetItemOperator;
import com.easyvaas.common.advancedRecyclerView.draggable.TopBottomEdgeEffectDecorator;
import com.easyvaas.common.advancedRecyclerView.utils.CustomRecyclerViewUtils;
import com.easyvaas.common.advancedRecyclerView.utils.WrapperAdapterUtils;
...
public class FooterViewRecyclerViewDragDropManager implements DraggableItemConstants {
     ...
     * Constructor.
     */
    public FooterViewRecyclerViewDragDropManager() {
        mInternalUseOnItemTouchListener = new RecyclerView.OnItemTouchListener() {
            @Override
            public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
                return FooterViewRecyclerViewDragDropManager.this.onInterceptTouchEvent(rv, e);
            }

            @Override
            public void onTouchEvent(RecyclerView rv, MotionEvent e) {
                FooterViewRecyclerViewDragDropManager.this.onTouchEvent(rv, e);
            }

            @Override
            public void onRequestDisallowInterceptTouchEvent(boolean disallowIntercept) {
                FooterViewRecyclerViewDragDropManager.this.onRequestDisallowInterceptTouchEvent(disallowIntercept);
            }
        };
        ...
        mInternalUseOnScrollListener = new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                FooterViewRecyclerViewDragDropManager.this.onScrollStateChanged(recyclerView, newState);
            }

            @Override
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                FooterViewRecyclerViewDragDropManager.this.onScrolled(recyclerView, dx, dy);
            }
        };
     ...
     * @return Wrapped adapter which is associated to this {@link FooterViewRecyclerViewDragDropManager} instance.
     */
...
//        }
    ...
    private boolean canStartDrag(RecyclerView.ViewHolder holder, int touchX, int touchY) {
        ...
        if (mWrapperAdapter.canStartDrag(holder, wrappedItemPosition, viewX, viewY)) {
            ...
            return (holder.getAdapterPosition() == origRootPosition) && (origRootPosition != mRecyclerView.getAdapter().getItemCount() - 1);
        } else {
            return false;
        }
    }
    ...
    private void swapItems(
        ...
        if (performSwapping && toPosition != mRecyclerView.getAdapter().getItemCount() - 1) {
    ...
    private static class ScrollOnDraggingProcessRunnable implements Runnable {
        private final WeakReference<FooterViewRecyclerViewDragDropManager> mHolderRef;
        private boolean mStarted;

        public ScrollOnDraggingProcessRunnable(FooterViewRecyclerViewDragDropManager holder) {
        ...
        public void start() {
            ...
            final FooterViewRecyclerViewDragDropManager holder = mHolderRef.get();
    ...
    private static class InternalHandler extends Handler {
        ...
        private FooterViewRecyclerViewDragDropManager mHolder;
        private MotionEvent mDownMotionEvent;

        public InternalHandler(FooterViewRecyclerViewDragDropManager holder) {
            mHolder = holder;
        }
