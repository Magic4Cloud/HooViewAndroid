...
import com.easyvaas.common.advancedRecyclerView.adapter.SimpleWrapperAdapter;
...
import com.easyvaas.common.advancedRecyclerView.swipeable.RecyclerViewSwipeManager;
import com.easyvaas.common.advancedRecyclerView.swipeable.SwipeableItemAdapter;
import com.easyvaas.common.advancedRecyclerView.swipeable.action.SwipeResultAction;
import com.easyvaas.common.advancedRecyclerView.swipeable.action.SwipeResultActionDefault;
...
public class DraggableItemWrapperAdapter<VH extends RecyclerView.ViewHolder> extends SimpleWrapperAdapter<VH> implements SwipeableItemAdapter<VH> {
    ...
    private FooterViewRecyclerViewDragDropManager mDragDropManager;
    ...
    public DraggableItemWrapperAdapter(FooterViewRecyclerViewDragDropManager manager, RecyclerView.Adapter<VH> adapter) {
        super(adapter);
