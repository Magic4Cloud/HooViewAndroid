package com.easyvaas.common.widget.progressbar;
...
public class HorizontalProgressBarWithNumber extends ProgressBar {
    ...
    private int measureHeight(int measureSpec) {
        ...
        if (specMode == MeasureSpec.EXACTLY) {
            ...
            result = (int) (getPaddingTop() + getPaddingBottom() + Math
    ...
    private void obtainStyledAttributes(AttributeSet attrs) {
        ...
        final TypedArray attributes = getContext()
                .obtainStyledAttributes(attrs, R.styleable.HorizontalProgressBarWithNumber);
