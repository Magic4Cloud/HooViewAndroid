package com.easyvaas.common.widget.stickylistview;
...
public class StickyListHeadersListView extends ListView {
    public static final String TAG = StickyListHeadersListView.class.getSimpleName();
    ...
    private boolean mAreHeadersSticky = true; //header whether to stay
    ...
    private OnLoadingMoreListener loadMoreListener;

    public void setLoadingMoreListener(OnLoadingMoreListener listener) {
        ...
        if (childCount != 0) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (viewToWatch == null
                        ...
                        .hasHeader())
                        || ((childIsFooter || ((WrapperView) child).hasHeader())
