...
package com.easyvaas.common.advancedRecyclerView.swipeable.action;
...
public abstract class SwipeResultAction {
    ...
    /**
     * This method is called immediately after returning from the {@link com.easyvaas.common.advancedRecyclerView.swipeable.SwipeableItemAdapter#onSwipeItem(RecyclerView.ViewHolder, int, int)} method.
