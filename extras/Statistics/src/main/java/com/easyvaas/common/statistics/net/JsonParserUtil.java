...
class JsonParserUtil {
    ...
    private static JSONObject checkResponse(String jsonString) {
        ...
        try {
            ...
            StatisticsLogger.w(TAG, "checkResponse wrong ", e);
        }
        return jsonObject;
    }
    ...
    public static List toJavaBeans(Object javabean, JSONObject jsonObject,
        ...
        try {
            ...
            StatisticsLogger.w(TAG, "toJavaBeans get json array failed, key: " + keyJsonArray, e);
            return list;
        }
        StatisticsLogger.d(TAG, "JsonArray length : " + jsonArray.length());
        ...
        if (size > 0) {
            try {
                ...
                StatisticsLogger.w(TAG, "toJavaBeans failed !!!", e);
    ...
    private static Object toJavaBean(Object javabean, Map<String, String> data) {
        ...
        for (Field field : fields) {
            // StatisticsLogger.d(TAG, "field: " + field.getName() + " modifier : " + field.getModifiers());
            ...
            // StatisticsLogger.d(TAG, "toJavaBean(), key : " + field.getName() + " value: " + value);
            ...
            try {
                ...
                StatisticsLogger.w(TAG, "toJavaBean() failed. ", e);
            }
        }
    ...
    public static Object toJavaBeanBySetMethod(Object javabean, JSONObject jsonObject) {
        ...
        for (Method method : methods) {
            try {
                ...
                StatisticsLogger.w(TAG, "toJavaBeanBySetMethod() failed. ", e);
    ...
    public static Map<String, String> toMap(JSONObject jsonObject) {
        StatisticsLogger.d(TAG, "toMap(), json: " + jsonObject);
        ...
        try {
            while (iterator.hasNext()) {
                ...
                // StatisticsLogger.d(TAG, "key : " + key + " \n value: " + value);
            }
        } catch (JSONException e) {
            StatisticsLogger.w(TAG, "String json toMap() failed. ", e);
        }
        return result;
    }
