...
package com.easyvaas.common.bottomsheet;
...
public class BottomSheet extends Dialog implements DialogInterface {
    ...
    BottomSheet(Context context, int theme) {
        ...
        TypedArray a = getContext()
                .obtainStyledAttributes(null, R.styleable.BottomSheet, R.attr.myBottomSheetStyle, 0);
        try {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Activity context) {
            ...
            TypedArray ta = context.getTheme().obtainStyledAttributes(new int[]{R.attr.myBottomSheetStyle});
            try {
        ...
        /**
         * Constructor using a context for this builder and the {@link BottomSheet} it creates with given style
         *
         * @param context A Context for built BottomSheet.
