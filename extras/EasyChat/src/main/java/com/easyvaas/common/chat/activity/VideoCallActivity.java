...
import com.easyvaas.common.chat.utils.CameraHelper;
            ...
            if (!cameraHelper.isStarted()) {
                if (!isInComingCall) {
                    try {
                        ...
                        SingleToast.show(VideoCallActivity.this, R.string.Is_not_yet_connected_to_the_server);
                    }
                }
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                ((TextView) findViewById(R.id.tv_is_p2p))
                                        .setText(EMChatManager.getInstance().isDirectCall()
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String s1 = getResources()
                                        .getString(R.string.The_other_party_refused_to_accept);
                                ...
                                String s4 = getResources()
                                        .getString(R.string.The_other_is_on_the_phone_please);
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            monitorTextView.setText(
                                    "宽x高：" + callHelper.getVideoWidth() + "x" + callHelper.getVideoHeight()
